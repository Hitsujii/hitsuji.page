---
title: Questions
summary: Small C++ questions I write down to feel relief.
---
# Questions
...
- [x] What does `std::` mean?  
       The C++ standard library lives in the [`std` namespace](cpp-fundamentals/namespaces).
- [x] What does `<<` mean?  
...
- [x] What is a translation unit?  
       A [preprocessed](cpp-fundamentals/preprocessor) `.cpp` file, meaning the state after expanding directives such as `#include` and `#define`.
